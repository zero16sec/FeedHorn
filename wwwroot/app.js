...
function createSslCard(cert) {
    ...
    div.innerHTML = `
        ...
        <div class="days-badge ${statusClass}">
            ${cert.daysUntilExpiration < 0 ? 'Expired' : `${cert.daysUntilExpiration} days remaining`}
        </div>
        ...
        <div class="ssl-info">
            ...
            <div class="ssl-info-row">
                ...
                <span class="ssl-value" style="font-size: 0.8rem;">${escapeHtml(cert.issuer.split(',')[0])}</span>
            </div>
            <div class="ssl-info-row">
                <span class="ssl-label">Last Checked</span>
                <span class="ssl-value" style="font-size: 0.8rem;">${lastChecked}</span>
            </div>
        </div>
    `;
